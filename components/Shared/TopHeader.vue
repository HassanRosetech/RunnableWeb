<template>
  <header
    class="relative wrapper !bg-[#ffffff]"
    style="
            ...
            <ul class="navbar-nav">
              <li class="nav-item dropdown dropdown-mega">
                ...
                >
                  <li class="mega-menu-content mega-menu-scroll">
                    ...
                    >
                      <li
                        class="xl:!px-[10px] xl:!mt-[10px] lg:!px-[10px] lg:!mt-[10px]"
                      >
                        <a class="dropdown-item" href="./demo1.html">
                          <figure
                            class="!rounded-[.4rem] lift hidden xl:block lg:block"
                          >
                            <img
                              class="!rounded-[.4rem]"
                    ...
                    <!--/.row -->
                    <span class="hidden xl:!flex lg:!flex"
                      ><i class="uil uil-direction before:content-['\ea93']"></i
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                  <li class="dropdown dropdown-submenu dropend">
                    <a
                      class="dropdown-item hover:!text-[#54a8c7] dropdown-toggle"
                      href="#"
                      data-bs-toggle="dropdown"
                      >Services</a
                    >
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-lg">
                  <div class="dropdown-lg-content">
                    <div>
                      <h6 class="dropdown-header !text-[#54a8c7]">
                        Project Pages
                      </h6>
              ...
              <li class="nav-item dropdown dropdown-mega">
                ...
                >
                  <li class="mega-menu-content">
                    ...
                    >
                      <li
                        class="xl:!px-[15px] xl:!mt-[20px] lg:!px-[15px] lg:!mt-[20px]"
                      >
                        <a
                          class="dropdown-item"
              ...
              <li class="nav-item dropdown dropdown-mega">
                ...
                <ul class="dropdown-menu mega-menu">
                  <li class="mega-menu-content">
                    <div
                      class="flex flex-wrap mx-0 xl:mx-[-7.5px] lg:mx-[-7.5px]"
                    >
                      <div
                        class="xl:w-4/12 lg:w-4/12 w-full flex-[0_0_auto] max-w-full"
                      >
                        <h6 class="dropdown-header !text-[#54a8c7]">Usage</h6>
                        <ul
                          class="pl-0 list-none xl:columns-2 lg:columns-2 xl:pb-1 lg:pb-1"
                        >
                          <li
                            class="xl:inline-block xl:w-full lg:inline-block lg:w-full"
                          >
                            <a
                              class="dropdown-item hover:!text-[#54a8c7]"
                        ...
                        <h6
                          class="dropdown-header !text-[#54a8c7] xl:!mt-6 lg:!mt-6"
                        >
                          Styleguide
                        </h6>
