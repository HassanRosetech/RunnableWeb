  ...
  <section class="wrapper bg-gradient-reverse-sky">
    <div class="container !pb-[4.5rem] xl:!pb-24 lg:!pb-24 md:!pb-24">
      ...
      >
        ...
        >
          <h2
            class="!text-[.75rem] uppercase !text-[#5eb9f0] !tracking-[0.02rem] !leading-[1.35] !mb-3"
          >
            Why Choose Us?
          </h2>
          <h3
            class="xl:!text-[2.1rem] !text-[calc(1.335rem_+_1.02vw)] !leading-[1.2] !mb-7"
          >
          ...
          <div class="accordion accordion-wrapper" id="accordionExample">
            <div class="card plain accordion-item">
              <div
                class="card-header !mb-0 !p-[0_0_.8rem_0] !border-0 !bg-inherit"
                id="headingOne"
              >
                <button
